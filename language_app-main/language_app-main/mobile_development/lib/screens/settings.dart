  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(S.of(context).settings, style: TextStyle(fontFamily: 'Fredoka',color: Color.fromARGB(255, 255, 255, 254), fontSize: 24)),
        ...
        child: Column(
          children: [
            ...
            Container( 
              ...
              child: Text(S.of(context).changeUsername, style: TextStyle(fontFamily: 'Fredoka', color: Color.fromARGB(255, 255, 255, 254), fontSize: 20)),
            ),
            ),
            ...
            Container( 
              ...
              child: Text(S.of(context).changeLanguage, style: TextStyle(fontFamily: 'Fredoka', color: Color.fromARGB(255, 255, 255, 254), fontSize: 20)),
            ),
            ),
            const SizedBox(height: 20),
            Container( 
              ...
              child: Text(S.of(context).changeTheme, style: TextStyle(fontFamily: 'Fredoka', color: Color.fromARGB(255, 255, 255, 254), fontSize: 20)),
            ),
            ),
          ]
        )
